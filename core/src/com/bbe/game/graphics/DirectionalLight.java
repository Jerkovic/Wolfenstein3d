...
public class DirectionalLight extends Light
{
    ...
    public DirectionalLight(final Vector3 position, final Vector3 direction)
    {
        super();
    ...
    public void init()
    {
        ...
        camera = new PerspectiveCamera(120f, 1024, 1024);
        camera.near = 1f;
        camera.far = 70;
    ...
    public void render(final ModelInstance modelInstance)
    {
        ...
        if (frameBuffer == null)
        {
            frameBuffer = new FrameBuffer(Format.RGBA8888, 1024,1024, true);
        }
